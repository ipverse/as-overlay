...
AS with no metadata at all. Just a flat array of ASN numbers:
```json
...
**Note**: These files are auto-generated by ipverse. Do not include them in your PR - only `overlay.json` should be modified.
